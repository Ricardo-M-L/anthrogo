...
| **30+ tools** | Bash sandbox · ContainerExec · Diff · Format · Git · SymbolSearch · References · WebFetch · WebSearch (4 backends) · HTTPRequest · SQLQuery · Speech I/O · Background tasks · **BrowserAction** (headless Chrome) · **SlackPost** (webhook) · **CalendarEvent** (.ics / Calendar.app) · **Embed** (OpenAI-compat embeddings) · **ImageGen** (OpenAI-compat image generation) — [docs/tools.md](docs/tools.md) |
