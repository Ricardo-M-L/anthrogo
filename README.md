...
| **30+ tools** | Bash sandbox · ContainerExec · Diff · Format · Git · SymbolSearch · References · WebFetch · WebSearch (4 backends) · HTTPRequest · SQLQuery · Speech I/O · Background tasks — [docs/tools.md](docs/tools.md) |
